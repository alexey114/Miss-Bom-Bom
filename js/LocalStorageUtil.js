class LocalStorageUtil {
    ...
    getProducts () {
        const productsLocalStorage = localStorage.getItem (this.keyName); //если будет значение вернется строка, иначе вернется null
    ...
    putProducts(id){ 
        ...
        const index = products.indexOf(id); //что бы не добавлялись дубли индексов, а удалялись делаем проверку
    ...
    //ВАЖНО! localStorage принимает только строки, следовательно делаем преобразование из массива через JSON.stringify
}
